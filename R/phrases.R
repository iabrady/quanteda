...
setGeneric("phrasetotoken", function(object, phrases, ...) standardGeneric("phrasetotoken"))

#' @rdname phrasetotoken
#' @export
setMethod("phrasetotoken", signature = c("corpus", "ANY"), function(object, phrases, ...) {
...
#'
setMethod("phrasetotoken", signature = c("character", "dictionary"), function(object, phrases, ...) {
...
#' @rdname phrasetotoken
#' @export
setMethod("phrasetotoken", signature = c("character", "collocations"), function(object, phrases, ...) {
...
setMethod("phrasetotoken", signature = c("character", "character"), function(object, phrases, concatenator = "_", valuetype = c("glob", "regex", "fixed"), case_insensitive = TRUE, ...) {
    valuetype <- match.arg(valuetype)
    if (valuetype == "glob" | valuetype == "fixed") 
        compoundPhrases <- stringi::stri_replace_all_fixed(phrases, c("*", "?"), c("[^\\s]*", "[^\\s]"), vectorize_all = FALSE)
